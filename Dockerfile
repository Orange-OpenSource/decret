...
RUN aptitude -y --allow-untrusted -o Aptitude::ProblemResolver::SolutionCost='100*canceled-actions,200*removals' install ${PACKAGE_NAME} || (echo "\n\n /!\\ WARNING /!\\ \n\nThe vulnerable package could not be installed. Please provide the bin-package name with '-p' option (see -h for help).\nCheck also that you are using the right Debian version.\nFinally, you can try to add an other version by running the command : apt-cache policy 'package_name'\n\n /!\\ WARNING /!\\ \n\n" >&2)
